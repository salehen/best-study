     				...
     				<div class="tab-content-details shadow-reset text-left">
     					<div class="row">
     						<div class="col-md-12 text-center page-header mt-b-30">
     							<h1>To See Confirm Applicants List Select Class and Section</h1>
     						</div>
     		...
     		<div class="row">
     			<div class="col-md-12" id="a-info">
     				...
     				<div id="aSearch" class="form-inline col-md-12 mt-10 p-0" style="display: none; width:100%">
     					<label for="mySearch" class="col-md-4 form-control">Search Applicant : </label>
     	...
     	<div class="modal-dialog" role="document">
     		<div class="modal-content">
     			...
     			<div class="modal-footer">
     				...
     				<!-- <form action="<?php //echo base_url('admin/applicant-confirm') ?>" method="POST">
