...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/css/dropzone/dropzone.css">
    <!-- style CSS
		============================================ -->
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="<?php echo base_url('dashboard') ?>"><img class="main-logo" src="<?php echo base_url() ?>assets/admin/img/logo/logo.png" alt="" /></a>
                <strong><a href="index.html"><img src="<?php echo base_url() ?>assets/admin/img/logo/logosn.png" alt="" /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu sub-pages" id="menu1">
                        <li class="active">
                        ...
                        <li>
                            <a title="Landing Page" href="<?php echo base_url('dashboard/event') ?>" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Event</span></a>
                        </li>
                        <li>
                            <a class="has-arrow" href="<?php echo base_url('dashboard/teacher') ?>" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Teachers</span></a>
                        ...
                        <li>
                            <a class="has-arrow" href="<?php echo base_url("dashboard/subject") ?>" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span> <span class="mini-click-non">Subjects</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                        ...
                        <li>
                            <a class="has-arrow" href="<?php echo base_url('dashboard/class-list') ?>" aria-expanded="false"><span class="educate-icon educate-department icon-wrap"></span> <span class="mini-click-non">Class</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                        ...
                        <li>
                            <a class="has-arrow" href="<?php echo base_url('dashboard/result') ?>" aria-expanded="false"><span class="educate-icon educate-library icon-wrap"></span> <span class="mini-click-non">Result</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Result" href="<?php echo base_url('dashboard/result') ?>"><span class="mini-sub-pro">View Result</span></a></li>
                                <li><a title="Add Result" href="<?php echo base_url('dashboard/add-result') ?>"><span class="mini-sub-pro">Add Result</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="<?php echo base_url('dashboard/exam') ?>" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap"></span> <span class="mini-click-non">Exam</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Exam Schedule" href="<?php echo base_url('dashboard/exam') ?>"><span class="mini-sub-pro">Exam Schedule</span></a></li>
                                <li><a title="Add Exam Schedule" href="<?php echo base_url('dashboard/add-exam') ?>"><span class="mini-sub-pro">Add Schedule</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="<?php echo base_url('dashboard/routine') ?>" aria-expanded="false"><span class="educate-icon educate-interface icon-wrap"></span> <span class="mini-click-non">Class Routine</span></a>
                            <ul class="submenu-angle interface-mini-nb-dp" aria-expanded="false">
                                <li><a title="Class Routine" href="<?php echo base_url('dashboard/routine') ?>"><span class="mini-sub-pro">Routine List</span></a></li>
                                <li><a title="Add Class Routine" href="<?php echo base_url('dashboard/add-routine') ?>"><span class="mini-sub-pro">Add Routine</span></a></li>
                            </ul>
                        </li>
                        
                        <li>
                            <a class="has-arrow" href="#" aria-expanded="false"><span class="educate-icon educate-message icon-wrap"></span> <span class="mini-click-non">Admission</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Pending Application" href="<?php echo base_url('dashboard/admission') ?>"><span class="mini-sub-pro">Pending Application</span></a></li>
                                <li><a title="Confirm Application" href="<?php echo base_url('dashboard/admission-confirm') ?>"><span class="mini-sub-pro">Confirm Application</span></a></li>
                                <li><a title="Admission Result" href="<?php echo base_url('dashboard/admission-result') ?>"><span class="mini-sub-pro">Admission Result</span></a></li>
                                <li><a title="Admission Setup" href="<?php echo base_url('dashboard/admission-setup') ?>"><span class="mini-sub-pro">Admission Setup</span></a></li>
                            </ul>
                        </li>
                        <!-- <li>
                        ...
                        <li id="removable">
                            <a class="has-arrow" href="#" aria-expanded="false"><span class="educate-icon educate-f icon-wrap"></span> <span class="mini-click-non">Pages</span></a>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                        ...
                                                        <span class="admin-name"><?php echo $this->session->userdata('name') ?></span>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demopro" href="#">Students <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demopro" class="collapse dropdown-header-top">
                                                <li><a href="<?php echo base_url('dashboard/student') ?>">All Students</a>
                                                </li>
