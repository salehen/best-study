$("document").ready(function () {
	...
	$("#section").change(function () {
		...
		if (secID) {
			$.ajax({
				type: "post",
				url: $("meta[name='url']").attr("content") + "admin/api/load-admission",
				data: {
					'sid': secID
				},
				success: function (response) {
					...
					if (response) {
						...
						for (var index in response) {
							...
							rtl += `<td>
										<button type="button" class="btn btn-primary app-btn" value="`+ response[index]['id'] + `" data-toggle="modal" data-target="#myModal" name="approve">Approve</button> 
										<button type="button" class="btn btn-danger app-btn" value="`+ response[index]['id'] + `"  data-toggle="modal" data-target="#myModal" name="cancel">Cancel</button>
									</td>`;
							rtl += "</tr>";
						}
						$('#a-info').show();
